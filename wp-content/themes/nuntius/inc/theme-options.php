			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Select a background color for the header and main menu', 'nuntius' ); ?></th>
					<td>
						...
						<input type="text" id="nuntius_theme_options_accent_color" name="nuntius_theme_options[accent_color]" value="<?php esc_attr_e( $options['accent_color'] ); ?>" />
				...
				<tr valign="top"><th scope="row"><?php _e( 'Select a link color', 'nuntius' ); ?></th>
					<td>
						...
						<input type="text" id="link_color" name="nuntius_theme_options[link_color]" value="<?php esc_attr_e( $options['link_color'] ); ?>" />
